...
# Load vectorizer
try:
    with open(r"C:\Users\Jafar\Desktop\Fake-news-detection\tfidf_vectorizer.pkl", 'rb') as f:
...
try:
    ...
    xgb_model.load_model(r"C:\Users\Jafar\Desktop\Fake-news-detection\xgb_model.json")
